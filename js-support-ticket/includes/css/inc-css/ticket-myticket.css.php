...
/* Search Ticket Form*/
	...
	div.js-ticket-search-wrp div.js-ticket-form-wrp form.js-filter-form div.js-filter-field-wrp input#jsst-datestart{background-image: url('.JSST_PLUGIN_URL.'includes/images/calender.png);background-repeat: no-repeat;background-position: 97% 11px;padding: 10px;height: 50px;line-height: initial;background-size: 25px;}
	div.js-ticket-search-wrp div.js-ticket-form-wrp form.js-filter-form div.js-filter-field-wrp input#jsst-dateend{background-image: url('.JSST_PLUGIN_URL.'includes/images/calender.png);background-repeat: no-repeat;background-position: 97% 11px;padding: 10px;height: 50px;line-height: initial;background-size: 25px;}
	div.js-ticket-search-wrp div.js-ticket-form-wrp form.js-filter-form div.js-filter-field-wrp select#jsst-departmentid{width: 100%;border-radius: unset;background: url('.JSST_PLUGIN_URL.'includes/images/selecticon.png) 96% / 4% no-repeat;padding: 10px;height: 50px;line-height: initial;}
	div.js-ticket-search-wrp div.js-ticket-form-wrp form.js-filter-form div.js-filter-field-wrp select#jsst-priorityid{width: 100%;border-radius: unset;background: url('.JSST_PLUGIN_URL.'includes/images/selecticon.png) 96% / 4% no-repeat ;padding: 10px;height: 50px;line-height: initial;}
	div.js-ticket-search-wrp div.js-ticket-form-wrp form.js-filter-form div.js-filter-field-wrp select#staffid{width: 100%;border-radius: unset;background: url('.JSST_PLUGIN_URL.'includes/images/selecticon.png) 96% / 4% no-repeat ;padding: 10px;height: 50px;line-height: initial;}
